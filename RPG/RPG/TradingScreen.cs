...
namespace RPG
{
    public partial class TradingScreen : Form
    {
        ...
        private void dgvMyItems_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }

        private void dgvVendorItems_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
