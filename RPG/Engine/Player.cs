...
namespace Engine
{
    public class Player : LivingCreature
    {
        ...
        public static Player CreateDefaultPlayer()
        {
            ...
            player.Inventory.Add(new InventoryItem(World.ItemByID(World.ITEM_ID_RUST_SWORD), 1));
        ...
        public bool HasRequiredItemToEnterThisLocation(Location location)
        {
            ...
            return Inventory.Any(ii => ii.Details.ID == location.ItemReqToEnter.ID);
        }
        ...
        public void MoveTo(Location newLocation)
        {
            ...
            {
                RaiseMessage("You must have a " + newLocation.ItemReqToEnter.Name + " to enter this location.");
                return;
            }
                ...
                if (playerAlreadyHasQuest)
                {
                    ...
                    if (!playerAlreadyCompletedQuest)
                    {
                        ...
                        if (playerHasAllItemsToCompleteQuest)
                        {
                            ...
                            RaiseMessage(newLocation.QuestAvailableHere.RewardXP + " experience points");
                            ...
                            AddExperiencePoints(newLocation.QuestAvailableHere.RewardXP);
        ...
        public void UseWeapon(Weapon weapon)
        {
            ...
            int damageToMonster = RNG.NumberBetween(weapon.MinDMG, weapon.MaxDMG);
            ...
            if (_currentMonster.CurrentHP <= 0)
            {
                ...
                AddExperiencePoints(_currentMonster.RewardXP);
                RaiseMessage("You receive " + _currentMonster.RewardXP + " experience points");
